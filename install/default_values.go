...
var (
	...
	defaultBoardData = model.Board{
		GrID:             defaultGrId,
		BoCommentLevel:   1,
		BoCountDelete:    1,
		BoReadPoint:      defaultReadPoint,
		BoWritePoint:     defaultWritePoint,
		BoCommentPoint:   defaultCommentPoint,
		BoDownloadPoint:  defaultDownloadPoint,
		BoUseCategory:    0,
		BoCategoryList:   "",
		BoUseSideview:    0,
		BoUseFileContent: 0,
